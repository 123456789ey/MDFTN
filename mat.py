'''将.npy文件批量转换成.mat文件,方便用matlab查看图像'''
...
def save_dataset(args):
    ...
    for i1 in range(len(a)):
        ...
        b = np.load(a[i1])
        f_name = '{}{}.mat'.format('x', i1)
        # io.savemat(os.path.join(args.data_path1, f_name), {('{}{}'.format('y', i1)): b})
        io.savemat(os.path.join(args.data_path1, f_name), {('{}'.format('x')): b})
        # io.savemat(os.path.join(args.data_path1, f_name), pp)
    # print(b.shape)
if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument('--data_path', type=str, default='./save_licnic1111/x_minfound')
    parser.add_argument('--data_path1', type=str, default='./save_licnic1111/x_minfound_MAT')
